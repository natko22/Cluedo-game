...
function pickMyMystery() {
  ...
  return {room, suspects, weapon}
  
}
let mystery = pickMyMystery()  
// Who killed Mr.Body with what in wich room.
// console.log(mystery);

// Loops through all of our arrays and each item's name.
...
function guess(){
  // console.log("guess")
  // console.log(mystery.suspects.name, 
  //                       mystery.weapon.name,
  //                       mystery.room.name)
...
if (guessedSuspect === mystery.suspects.name && guessedWeapon === mystery.weapon.name && guessedRoom === mystery.room.name) {
  alert ("You guessed right! You win!")
}
else {
  alert ("You guessed wrong!")
  alert (mystery.suspects.name + ' killed Mr. Boddy in the ' + mystery.room.name + ' with the ' + mystery.weapon.name   )
}
